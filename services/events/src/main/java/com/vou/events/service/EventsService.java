...
import com.vou.events.common.*;
import com.vou.events.dto.*;
			...
			if (this.addGamesToEvent(eventId, eventRegistrationInfoDto.getListGameId_StartTime())) {
				...
				try {
					for (GameId_StartTime gameId_StartTime : eventRegistrationInfoDto.getListGameId_StartTime()) {
						log.info("GameId_StartTime: " + gameId_StartTime.getGameId());
						log.info("GameId_StartTime: " + gameId_StartTime.getStartTime());
						log.info("GameId_StartTime: " + gameId_StartTime.getGameType());
