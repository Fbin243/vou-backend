...
@Document(collection = "item_received_transactions")
@Data
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class ItemReceivedTransaction implements Transaction {
    @Id
    private ObjectId id;
    ...
    private String transactionType = TRANSACTION_TYPE_ITEM_RECEIVED;
