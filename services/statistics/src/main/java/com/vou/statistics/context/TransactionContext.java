...
public class TransactionContext {
    ...
    public boolean executeStrategy(Transaction transaction, PlayerVoucherService playerVoucherService, PlayerItemService playerItemService) {
        return transactionStrategy.processTransaction(transaction, playerVoucherService, playerItemService);
    }
}
